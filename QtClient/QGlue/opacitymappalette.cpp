...
uint OpacityMapPalette::setOpacityExpression(const std::string eq)
//void OpacityMapPalette::setOpacityMapEquation( const std::string& eq )
{
    ...
    FuncParser::FunctionParser of_parse( eq, eq.size() + 1 );
    FuncParser::FunctionParser::Error err_o = of_parse.express( of, vars );
