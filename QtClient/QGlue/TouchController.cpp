...
TouchController::TouchController(kvs::oculus::jaea::HeadMountedDisplay& hmd, kvs::Scene *scene ):
...
// 2020118
void TouchController::rebuildControlSphere(){
    ...
    if ( m_both_is_grabbed && PBVRWidgetHandlerInstance()->isEnabledControlSphere()) {
#ifdef DEBUG_TOUCH_CONTROLLER
